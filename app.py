...
if not st.session_state.auth_token:
    ...
    if "code" in query_params:
        ...
        # Explicit separator characters inserted to prevent domain collisions
...
# ==============================================================================
    ...
    if not st.session_state.tenant_id:
        try:
            ...
            if connections:
                st.session_state.tenant_id = connections["tenantId"]
                st.session_state.tenant_name = connections["tenantName"]
                st.rerun()
            else:
