...
# Production Subdomain Endpoints Mapping (Crucial Fix)
AUTH_URL = "https://xero.com"
TOKEN_URL = "https://identity.xero.com/connect/token"
TENANT_API_URL = "https://api.xero.com/connections"

# Character-for-character production match string
...
# --- WORKSPACE PATH B: OFFLINE PANEL VIEW ---
    ...
    # Complete, unbroken URL path query structure string
    auth_redirect_url = f"{AUTH_URL}?response_type=code&client_id={CLIENT_ID}&redirect_uri={encoded_redirect}&scope={encoded_scopes}&state=gigo_manual_stable_loop"
